(function (global, factory) {
    ...
    (factory((global.ng = global.ng || {}, global.ng.grid = global.ng.grid || {}),global.ng.core,global.rxjs));
...
var NgGrid = /** @class */ (function () {
    ...
    function NgGrid(_differs, _ngEl, _renderer, componentFactoryResolver) {
        ...
        this.onResizeStop = new i0.EventEmitter();
        this.onItemChange = new i0.EventEmitter();
        //	Public variables
        this.colWidth = 250;
        this.rowHeight = 250;
        this.minCols = 1;
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(NgGrid, [{
    ...
    }], function () { return [{ type: i0.KeyValueDiffers }, { type: i0.ElementRef }, { type: i0.Renderer2 }, { type: i0.ComponentFactoryResolver }]; }, { onDragStart: [{
            type: i0.Output
        }], onDrag: [{
            type: i0.Output
        }], onDragStop: [{
...
var NgGridItem = /** @class */ (function () {
    ...
    function NgGridItem(_differs, _ngEl, _renderer, _ngGrid, containerRef) {
        ...
        //	Event Emitters
        this.onItemChange = new i0.EventEmitter(false);
        this.onDragStart = new i0.EventEmitter();
        this.onDrag = new i0.EventEmitter();
        this.onDragStop = new i0.EventEmitter();
        this.onDragAny = new i0.EventEmitter();
        this.onResizeStart = new i0.EventEmitter();
        this.onResize = new i0.EventEmitter();
        this.onResizeStop = new i0.EventEmitter();
        this.onResizeAny = new i0.EventEmitter();
        this.onChangeStart = new i0.EventEmitter();
        this.onChange = new i0.EventEmitter();
        this.onChangeStop = new i0.EventEmitter();
        this.onChangeAny = new i0.EventEmitter();
        this.ngGridItemChange = new i0.EventEmitter();
        // tslint:enable:object-literal-sort-keys
        this.isFixed = false;
    ...
    NgGridItem.ɵfac = function NgGridItem_Factory(t) { return new (t || NgGridItem)(i0.ɵɵdirectiveInject(i0.KeyValueDiffers), i0.ɵɵdirectiveInject(i0.ElementRef), i0.ɵɵdirectiveInject(i0.Renderer2), i0.ɵɵdirectiveInject(NgGrid), i0.ɵɵdirectiveInject(i0.ViewContainerRef)); };
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(NgGridItem, [{
    ...
    }], function () { return [{ type: i0.KeyValueDiffers }, { type: i0.ElementRef }, { type: i0.Renderer2 }, { type: NgGrid }, { type: i0.ViewContainerRef }]; }, { onItemChange: [{
            type: i0.Output
        }], onDragStart: [{
            type: i0.Output
        }], onDrag: [{
...
var NgGridModule$$1 = /** @class */ (function () {
    function NgGridModule$$1() {
    }
    NgGridModule$$1.ɵfac = function NgGridModule_Factory(t) { return new (t || NgGridModule$$1)(); };
    NgGridModule$$1.ɵmod = /*@__PURE__*/ i0.ɵɵdefineNgModule({ type: NgGridModule$$1 });
    NgGridModule$$1.ɵinj = /*@__PURE__*/ i0.ɵɵdefineInjector({});
    return NgGridModule$$1;
}());
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(NgGridModule$$1, [{
        type: i0.NgModule,
        args: [{
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && i0.ɵɵsetNgModuleScope(NgGridModule$$1, { declarations: [NgGrid, NgGridItem, NgGridPlaceholder], exports: [NgGrid, NgGridItem] }); })();
