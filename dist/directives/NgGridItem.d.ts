...
export declare class NgGridItem implements OnInit, OnDestroy, DoCheck {
    ...
    static ɵfac: i0.ɵɵFactoryDeclaration<NgGridItem, never>;
    static ɵdir: i0.ɵɵDirectiveDeclaration<NgGridItem, "[ngGridItem]", never, { "config": "ngGridItem"; }, { "onItemChange": "onItemChange"; "onDragStart": "onDragStart"; "onDrag": "onDrag"; "onDragStop": "onDragStop"; "onDragAny": "onDragAny"; "onResizeStart": "onResizeStart"; "onResize": "onResize"; "onResizeStop": "onResizeStop"; "onResizeAny": "onResizeAny"; "onChangeStart": "onChangeStart"; "onChange": "onChange"; "onChangeStop": "onChangeStop"; "onChangeAny": "onChangeAny"; "ngGridItemChange": "ngGridItemChange"; }, never>;
}
